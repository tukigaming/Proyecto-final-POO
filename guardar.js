...
function guardar() {
    ...
    const clicks = parseInt(document.getElementById("botonlike").value); // Obtener el valor actual de clics y convertirlo a entero
...
function actualizarContador(documento) {
    ...
    const storyRef = db.collection('contador').doc(documento);
